...
[Enter useful description for GPUImageProcessing]
...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/PolinaSavelyeva/GPUImageProcessing/workflows/Build%20main/badge.svg)](https://github.com/PolinaSavelyeva/GPUImageProcessing/actions?query=branch%3Amain) |
[![Build History](https://buildstats.info/github/chart/PolinaSavelyeva/GPUImageProcessing)](https://github.com/PolinaSavelyeva/GPUImageProcessing/actions?query=branch%3Amain) |

## NuGet

Package | Stable | Prerelease
--- | --- | ---
GPUImageProcessing | [![NuGet Badge](https://buildstats.info/nuget/GPUImageProcessing)](https://www.nuget.org/packages/GPUImageProcessing/) | [![NuGet Badge](https://buildstats.info/nuget/GPUImageProcessing?includePreReleases=true)](https://www.nuget.org/packages/GPUImageProcessing/)
...
```
$ tree src/GPUImageProcessing/bin/
src/GPUImageProcessing/bin/
└── Debug
    └── net6.0
        ├── GPUImageProcessing.deps.json
        ├── GPUImageProcessing.dll
        ├── GPUImageProcessing.pdb
        └── GPUImageProcessing.xml
...
git branch -M main
git remote add origin https://github.com/PolinaSavelyeva/GPUImageProcessing.git
git push -u origin main
```

- [Create your NuGeT API key](https://docs.microsoft.com/en-us/nuget/nuget-org/publish-a-package#create-api-keys)
    - Add your NuGet API key as repository secret NUGET_TOKEN to [Actions secrets](https://github.com/PolinaSavelyeva/GPUImageProcessing/settings/secrets/actions)
...
[Unreleased]: https://github.com/PolinaSavelyeva/GPUImageProcessing/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/PolinaSavelyeva/GPUImageProcessing/releases/tag/v0.1.0
```
...
- The [Github Action](https://github.com/PolinaSavelyeva/GPUImageProcessing/blob/main/.github/workflows/publish.yml) will handle the new tag:
...
- Set Source for "Build and deployment" on [GitHub Pages](https://github.com/PolinaSavelyeva/GPUImageProcessing/settings/pages) to `GitHub Actions`.
- Documentation is auto-deployed via [Github Action](https://github.com/PolinaSavelyeva/GPUImageProcessing/blob/main/.github/workflows/fsdocs-gh-pages.yml) to [Your GitHub Page](https://PolinaSavelyeva.github.io/GPUImageProcessing/)
