...
[<assembly: AssemblyTitleAttribute("GPUImageProcessing.Tests")>]
[<assembly: AssemblyProductAttribute("GPUImageProcessing")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "GPUImageProcessing.Tests"
    let [<Literal>] AssemblyProduct = "GPUImageProcessing"
