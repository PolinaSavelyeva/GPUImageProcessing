        ...
        [ testCase "360 degree MyImage counterclockwise rotation is equal to the original"
          <| fun _ ->
              ...
              Expect.equal
                  result.Data
                  myImage1.Data
                  $"Unexpected: %A{result.Data}.\n Expected: %A{myImage1.Data}. "

              Expect.equal
                  result.Height
                  myImage1.Height
                  $"Unexpected: %A{result.Height}.\n Expected: %A{myImage1.Height}. "

              Expect.equal
                  result.Width
                  myImage1.Width
                  $"Unexpected: %A{result.Width}.\n Expected: %A{myImage1.Width}. "
          ...
          testPropertyWithConfig
              myConfig
              "360 degree counter/clockwise rotation is equal to the original on generated MyImage"
          <| fun myImage ->
              ...
              Expect.allEqual
                  resultsArray
                  myImage.Data
                  $"Unexpected: %A{resultsArray} and original {myImage.Data}.\n Expected equality. "
          ...
          testPropertyWithConfig
              myConfig
              "Two vertical/horizontal MyImage flips is equal to the original on generated MyImage"
          <| fun myImage ->
